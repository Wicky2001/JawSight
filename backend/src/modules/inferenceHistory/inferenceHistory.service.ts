...
import type { GetInferenceHistoryRequestType,GetInferenceHistoryResponseType,InferenceHistoryRowType } from "../../../../shared/types/inferenceHistory.types.js";
import { Op } from "sequelize";

export const getInferenceHistory = async (query: GetInferenceHistoryRequestType, doctorId: number): Promise<GetInferenceHistoryResponseType> => {
